...
The framework has a JUCE-like structure for audio DSP backend processing in C++ and Rust. Feed it C++ and/or Rust code, and one or more WAV files, and it will write a new 32-bit float WAV per file per programming language, processed by the code you give it.
